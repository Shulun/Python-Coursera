...
def print_third_verse():
    ...
    if choice == 0:
        ...
        print "Even if you don't share my passion for Pistachio"
    elif choice == 2:
...
def print_fourth_verse():
    ...
    if choice == 0:
        ...
        print "I'll clean all your dirty dishes"
...
def print_stanza():
    ...
    print_third_verse()
    print_fourth_verse()
    print "Because I love you madly, babe"
    print "Because I love you madly, babe"
    print " "
